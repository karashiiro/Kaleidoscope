...
int main(int, char**)
{
	...
	while (!done)
	{
		...
		// Perform our per-frame update logic
		app.OnUpdate();
		...
		const float clear_color_with_alpha[4] = {app.ClearColor.x * app.ClearColor.w, app.ClearColor.y * app.ClearColor.w, app.ClearColor.z * app.ClearColor.w, app.ClearColor.w};
